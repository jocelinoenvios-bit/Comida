...
CREATE TABLE "Favorite" (
    ...
    CONSTRAINT "Favorite_pkey" PRIMARY KEY ("userId","establishmentId")
);
...
CREATE TABLE "AdditionItem" (
    ...
    CONSTRAINT "AdditionItem_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Establishment" ADD CONSTRAINT "Establishment_neighborhoodId_fkey" FOREIGN KEY ("neighborhoodId") REFERENCES "Neighborhood"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Establishment" ADD CONSTRAINT "Establishment_planId_fkey" FOREIGN KEY ("planId") REFERENCES "Plan"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MenuSection" ADD CONSTRAINT "MenuSection_establishmentId_fkey" FOREIGN KEY ("establishmentId") REFERENCES "Establishment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AdditionItem" ADD CONSTRAINT "AdditionItem_establishmentId_fkey" FOREIGN KEY ("establishmentId") REFERENCES "Establishment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_ProductAdditions" ADD CONSTRAINT "_ProductAdditions_A_fkey" FOREIGN KEY ("A") REFERENCES "AdditionItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ProductAdditions" ADD CONSTRAINT "_ProductAdditions_B_fkey" FOREIGN KEY ("B") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
